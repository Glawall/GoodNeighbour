...
const helpRequestsService = __importStar(require("../../services/helpRequests/getByHelpRequestId"));
const checkValidation_1 = require("../../utils/checkValidation");
const getByHelpRequestId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const helpRequest = yield helpRequestsService.getByHelpRequestId(helpRequestId);
