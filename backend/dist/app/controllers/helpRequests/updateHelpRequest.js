...
const updateHelpRequest = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedHelpRequest = yield helpRequestsServices.updateHelpRequest(authUserId, helpRequestId, helpRequestBody);
