...
const updateHelpOffer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedHelpOffer = yield helpOffersService.updateHelpOffer(helpRequestId, helperId, authUserId, req.body);
