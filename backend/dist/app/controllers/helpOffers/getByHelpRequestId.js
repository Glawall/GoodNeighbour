...
const helpOffersService = __importStar(require("../../services/helpOffers/getByHelpRequestId"));
...
const getByHelpRequestId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const helpOffers = yield helpOffersService.getByHelpRequestId(helpRequestId);
