...
const helpOffersServices = __importStar(require("../../services/helpOffers/removeHelpOffer"));
const checkValidation_1 = require("../../utils/checkValidation");
const removeHelpOffer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield helpOffersServices.removeHelpOffer(helpRequestId, helperId, authUserId);
        res.status(204).send();
    }
    catch (error) {
        next(error);
