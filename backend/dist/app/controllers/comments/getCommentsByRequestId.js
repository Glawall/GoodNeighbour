...
const getCommentsByRequestId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const comments = yield commentsService.getCommentsByRequestId(helpRequestId);
