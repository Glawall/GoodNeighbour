...
const threadComments_1 = require("../../utils/threadComments");
...
const getCommentsByRequestId = (helpRequestId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const comments = yield commentsRepo.getCommentsByRequestId(helpRequestId);
    return (0, threadComments_1.threadComments)(comments);
});
